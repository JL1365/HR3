...
import {createPenaltyLevel,getPenaltyLevels,updatePenaltyLevel,deletePenaltyLevel,} from "../controllers/penaltyController.js";

const penaltyRoute = express.Router();

penaltyRoute.post("/create-penalty-level", createPenaltyLevel);
penaltyRoute.get("/get-all-penalty-levels", getPenaltyLevels);
