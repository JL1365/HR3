...
const exportTableAsImage = (tableRef, fileName) => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-xl font-bold mb-2">Salary Computation</h1>

      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold">Gross Salary Data</h2>
        <button 
      ...
      {grossSalaryData ? renderTable(grossSalaryData, 'gross') : <p>Loading...</p>}

      <div className="flex justify-between items-center mb-4 mt-8">
        <h2 className="text-lg font-semibold">Net Salary Data</h2>
        <button 
          className="btn btn-sm btn-primary"
      ...
      {netSalaryData ? renderTable(netSalaryData, 'net') : <p>Loading...</p>}

      {renderEmployeeDetailsTable()}

      {openModalData && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg max-w-4xl w-full overflow-y-auto max-h-[90vh]">
            <div className="flex justify-between items-center mb-4">
